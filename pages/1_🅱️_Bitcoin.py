...
if btc_option == "BTC_100k":
    st.image("hvplot_images/bitcoin_graphs/bitcoin_100K.png", use_column_width=True)

if btc_option == "Price":
    st.image("hvplot_images/bitcoin_graphs/bitcoin_price.png", use_column_width=True)
...
if btc_option == "AAC":
    st.image("hvplot_images/bitcoin_graphs/bitcoin_aac.png", use_column_width=True)
...
if btc_option == "volatility":
    st.image(
        "hvplot_images/bitcoin_graphs/bitcoin_volatility.png", use_column_width=True,
    )
